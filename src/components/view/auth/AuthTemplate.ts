...
registrationTemplate.innerHTML = `
  <form id="reg-form" class="popup">
    ...
    <input class="popup__input" required type="text" name="name" placeHolder="Имя">
    <input class="popup__input" required type="password" name="password" placeHolder="Пароль">
    <input class="popup__input" required type="password" name="password-confirm" placeHolder="Повторно пароль">
...
authTemplate.innerHTML = `
  <form id="auth-form" class="popup">
    ...
    <input class="popup__input" required name="password" type="password" placeHolder="Пароль">
