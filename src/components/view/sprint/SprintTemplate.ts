...
export const sprintStartTemplate = (unitId?: string): HTMLTemplateElement => {
  ...
  sprintStart.innerHTML = `
    <div class="start-sprint unit-${unitId || 1}" data-id="${unitId || 1}">
      <h1>Спринт</h1>
      <p>Выберите соответсвует ли перевод предложенному слову</p>
      <div class="unit-select">
        <a href="#/sprint/1/" data-id="1" class="unit-select__button unit-1">Раздел 1</a>
        <a href="#/sprint/2/" data-id="2" class="unit-select__button unit-2">Раздел 2</a>
        <a href="#/sprint/3/" data-id="3" class="unit-select__button unit-3">Раздел 3</a>
        <a href="#/sprint/4/" data-id="4" class="unit-select__button unit-4">Раздел 4</a>
        <a href="#/sprint/5/" data-id="5" class="unit-select__button unit-5">Раздел 5</a>
        <a href="#/sprint/6/" data-id="6" class="unit-select__button unit-6">Раздел 6</a>
      </div>
